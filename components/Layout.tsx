...
export default function Layout({ children }: { children: React.ReactChild }) {
  return (
    <Fragment>
      <div className="shadow text-white rounded-lg py-1 text-sm bg-gradient-to-r from-purple-500 to-pink-500 my-10 w-full max-w-3xl mx-auto">
        <div className="flex items-center px-3  justify-between bg-gradient-to-r from-purple-500 to-pink-500 sticky top-0">
          <Tabs
